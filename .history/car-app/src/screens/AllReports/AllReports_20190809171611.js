...
//With the Params id, content and except
  ...
  addDeleteReadlater =id =>{
    if(this.state.read_later_button_text.includes('Remove')){
      return this.handleAddFavourite(id);
    }
    else {
  ...
  addDeleteFavorite =id =>{
    if(this.state.favorite_button_text.includes('Remove')) {
      return this.handleAddFavourite(id);
    }
    else {
        ...
        <TouchableOpacity 
          ...
          <View style = {styles.txtView}>
            ...
            <SubmitButton
              ...
              onPress={()=>this.addRemoveFavourite(id)}
              titleStyle={styles.btnText}
              btnStyle = {styles.btnStyle}
            />
            <SubmitButton
              title={read_later_button_text}
              onPress={()=>this.addDeleteReadlater(id)}
              titleStyle={styles.btnText}
              btnStyle = {styles.btnReadLate}
            />
