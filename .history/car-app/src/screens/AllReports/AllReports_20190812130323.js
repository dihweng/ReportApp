  ...
  addFavorite = async(id, index) =>{
    ...
    try {
      ...
      if (res.status >= 200 && res.status < 300) {    
        ...
        return this.showNotification('success', 'Message', 'Report Added to Favorite');
  ...
  readLater = async(id, index) =>{
    ...
    try {
      ...
      if(res.status >= 200 && res.status < 300) {
        ...
        await this.setState({ data });
        await this.hideLoadingDialogue();
        return this.showNotification('success', 'Message', 'Report Added Successfully');
  ...
  deleteFavorite = async(id, index)=> {
    ...
    try {
      ...
      if(res.status >= 200 && res.status < 300) {
        ...
        await this.setState({ data });
        await this.hideLoadingDialogue();
        return this.showNotification('success', 'Message', 'Report removal successful');
