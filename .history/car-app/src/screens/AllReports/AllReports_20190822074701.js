...
import { View, FlatList, ScrollView, SafeAreaView, StatusBar,   ActivityIndicator,TouchableOpacity, Image, RefreshControl, AsyncStorage, StyleSheet,} from 'react-native';
      ...
      .then((res) => {
        if (typeof res.message !== 'undefined') {  
          ...
          this.setState({
            ...
            current_page_no: res.data.meta.current_page,
            last_page_no: res.data.meta.last_page,
            isFetching: false, 
          });
          return this.hideLoadingDialogue();
        }
