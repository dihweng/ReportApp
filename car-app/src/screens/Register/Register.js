...
class Register extends Component {
  ...
  handleSignUp = async () => {
    const { name, email, password, password2, phoneNumber, nameCode, referralCode } = this.state;
    // let referral_code = referralCode.toString()
  ...
  handleReferralChange = (referralCode) => {
        ...
        <KeyboardAvoidingView
          ...
          <View style = {styles.formView}>
            ...
            <InputField
              ...
              inputType={'email'}
              keyboardType={'default'}
              onChangeText = {this.handleReferralChange}
              autoCapitalize = "none"
              height = {40}
              borderWidth = {1}
              borderColor={colors.darkSilver}
